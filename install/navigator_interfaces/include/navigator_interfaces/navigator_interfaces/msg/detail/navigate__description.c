  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xb4, 0x77, 0xbe, 0x19, 0x8d, 0x4d, 0xbe, 0xd9,
      0x09, 0x91, 0x36, 0x3b, 0x3f, 0xb8, 0x3d, 0x04,
      0x3e, 0xe7, 0x17, 0xc1, 0x79, 0xa6, 0x05, 0x55,
      0xdb, 0x62, 0x9d, 0xe6, 0x4c, 0x83, 0x4a, 0x65,
    }};
  return &hash;
}
...
static char navigator_interfaces__msg__Navigate__TYPE_NAME[] = "navigator_interfaces/msg/Navigate";
...
static char navigator_interfaces__msg__Navigate__FIELD_NAME__pose[] = "pose";
static char navigator_interfaces__msg__Navigate__FIELD_NAME__instant[] = "instant";

static rosidl_runtime_c__type_description__Field navigator_interfaces__msg__Navigate__FIELDS[] = {
  {
    {navigator_interfaces__msg__Navigate__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {navigator_interfaces__msg__Navigate__FIELD_NAME__instant, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription navigator_interfaces__msg__Navigate__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {navigator_interfaces__msg__Navigate__TYPE_NAME, 33, 33},
      {navigator_interfaces__msg__Navigate__FIELDS, 2, 2},
    },
    {navigator_interfaces__msg__Navigate__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
navigator_interfaces__msg__Navigate__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *navigator_interfaces__msg__Navigate__get_individual_type_description_source(NULL),
