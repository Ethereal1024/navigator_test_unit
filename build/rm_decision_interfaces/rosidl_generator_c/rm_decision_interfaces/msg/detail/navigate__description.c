  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xbd, 0x9f, 0xc5, 0xc5, 0xe3, 0x9a, 0x7c, 0x5c,
      0x0b, 0xc0, 0x7b, 0x3b, 0xef, 0x4d, 0xd0, 0x25,
      0x2a, 0xb2, 0xdd, 0xfc, 0x1a, 0xb6, 0xb2, 0x7c,
      0x63, 0xd6, 0x80, 0x2e, 0x32, 0x8f, 0xc2, 0x41,
    }};
  return &hash;
}
...
static char rm_decision_interfaces__msg__Navigate__TYPE_NAME[] = "rm_decision_interfaces/msg/Navigate";
...
static char rm_decision_interfaces__msg__Navigate__FIELD_NAME__pose[] = "pose";
static char rm_decision_interfaces__msg__Navigate__FIELD_NAME__instant[] = "instant";

static rosidl_runtime_c__type_description__Field rm_decision_interfaces__msg__Navigate__FIELDS[] = {
  {
    {rm_decision_interfaces__msg__Navigate__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {rm_decision_interfaces__msg__Navigate__FIELD_NAME__instant, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription rm_decision_interfaces__msg__Navigate__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {rm_decision_interfaces__msg__Navigate__TYPE_NAME, 35, 35},
      {rm_decision_interfaces__msg__Navigate__FIELDS, 2, 2},
    },
    {rm_decision_interfaces__msg__Navigate__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *rm_decision_interfaces__msg__Navigate__get_individual_type_description_source(NULL),
