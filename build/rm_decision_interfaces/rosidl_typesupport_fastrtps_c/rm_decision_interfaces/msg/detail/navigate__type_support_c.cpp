...
#include "rm_decision_interfaces/msg/detail/navigate__rosidl_typesupport_fastrtps_c.h"
...
using _Navigate__ros_msg_type = rm_decision_interfaces__msg__Navigate;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
bool cdr_serialize_rm_decision_interfaces__msg__Navigate(
  const rm_decision_interfaces__msg__Navigate * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pose
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
bool cdr_deserialize_rm_decision_interfaces__msg__Navigate(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces__msg__Navigate * ros_message)
{
  // Field name: pose
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t get_serialized_size_rm_decision_interfaces__msg__Navigate(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t max_serialized_size_rm_decision_interfaces__msg__Navigate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces__msg__Navigate;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
bool cdr_serialize_key_rm_decision_interfaces__msg__Navigate(
  const rm_decision_interfaces__msg__Navigate * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pose
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t get_serialized_size_key_rm_decision_interfaces__msg__Navigate(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Navigate__ros_msg_type * ros_message = static_cast<const _Navigate__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t max_serialized_size_key_rm_decision_interfaces__msg__Navigate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rm_decision_interfaces__msg__Navigate * ros_message = static_cast<const rm_decision_interfaces__msg__Navigate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rm_decision_interfaces__msg__Navigate(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rm_decision_interfaces__msg__Navigate * ros_message = static_cast<rm_decision_interfaces__msg__Navigate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rm_decision_interfaces__msg__Navigate(cdr, ros_message);
}

static uint32_t _Navigate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_decision_interfaces__msg__Navigate(
...
static size_t _Navigate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_decision_interfaces__msg__Navigate(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_decision_interfaces, msg, Navigate)() {
