...
bool cdr_serialize_rm_decision_interfaces__msg__FriendLocation(
  const rm_decision_interfaces__msg__FriendLocation * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
bool cdr_deserialize_rm_decision_interfaces__msg__FriendLocation(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces__msg__FriendLocation * ros_message)
{
  // Field name: hero_x
  {
    cdr >> ros_message->hero_x;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
bool cdr_serialize_key_rm_decision_interfaces__msg__FriendLocation(
  const rm_decision_interfaces__msg__FriendLocation * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: hero_x
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t get_serialized_size_key_rm_decision_interfaces__msg__FriendLocation(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FriendLocation__ros_msg_type * ros_message = static_cast<const _FriendLocation__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_decision_interfaces
size_t max_serialized_size_key_rm_decision_interfaces__msg__FriendLocation(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rm_decision_interfaces__msg__FriendLocation * ros_message = static_cast<const rm_decision_interfaces__msg__FriendLocation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rm_decision_interfaces__msg__FriendLocation(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rm_decision_interfaces__msg__FriendLocation * ros_message = static_cast<rm_decision_interfaces__msg__FriendLocation *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rm_decision_interfaces__msg__FriendLocation(cdr, ros_message);
}
