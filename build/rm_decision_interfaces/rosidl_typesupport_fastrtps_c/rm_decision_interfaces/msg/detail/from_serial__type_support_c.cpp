  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rm_decision_interfaces__msg__FromSerial * ros_message = static_cast<const rm_decision_interfaces__msg__FromSerial *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rm_decision_interfaces__msg__FromSerial(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rm_decision_interfaces__msg__FromSerial * ros_message = static_cast<rm_decision_interfaces__msg__FromSerial *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rm_decision_interfaces__msg__FromSerial(cdr, ros_message);
}
