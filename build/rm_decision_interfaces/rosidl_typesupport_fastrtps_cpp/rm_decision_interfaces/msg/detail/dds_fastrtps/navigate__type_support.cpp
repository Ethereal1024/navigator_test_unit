...
#include "rm_decision_interfaces/msg/detail/navigate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_decision_interfaces::msg::Navigate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_decision_interfaces::msg::Navigate & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_decision_interfaces::msg::Navigate;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rm_decision_interfaces
max_serialized_size_key_Navigate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const rm_decision_interfaces::msg::Navigate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_decision_interfaces::msg::Navigate *>(
    untyped_ros_message);
...
get_message_type_support_handle<rm_decision_interfaces::msg::Navigate>()
{
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_Navigate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_decision_interfaces, msg, Navigate)() {
  return &rm_decision_interfaces::msg::typesupport_fastrtps_cpp::_Navigate__handle;
}
