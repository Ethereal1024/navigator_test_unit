...
{
  new (message_memory) rm_decision_interfaces::msg::Navigate(_init);
}

void Navigate_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_decision_interfaces::msg::Navigate *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Navigate_message_member_array[2] = {
  {
    ...
    offsetof(rm_decision_interfaces::msg::Navigate, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_decision_interfaces::msg::Navigate, instant),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Navigate_message_members = {
  ...
  2,  // number of fields
  sizeof(rm_decision_interfaces::msg::Navigate),
...
{
  return &::rm_decision_interfaces::msg::rosidl_typesupport_introspection_cpp::Navigate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_decision_interfaces, msg, Navigate)() {
  return &::rm_decision_interfaces::msg::rosidl_typesupport_introspection_cpp::Navigate_message_type_support_handle;
}
