...
#define NODE_MAIN_LOGGER_NAME "navigator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libnavigator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<RMDecision::Navigator>";
